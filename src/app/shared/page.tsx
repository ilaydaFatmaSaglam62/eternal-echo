    ...
    <main className="flex-1 flex items-center justify-center p-6 lg:p-12 font-sans overflow-hidden">
      <div className="max-w-4xl w-full flex flex-col items-center justify-center">
        ...
        <div className="text-center mb-12">
          ...
          <p className="font-inter text-sm text-[var(--text-muted)] tracking-wide font-light max-w-lg mx-auto">
        ...
        <div className="w-full bg-white rounded-2xl p-8 sm:p-12 shadow-layered border-subtle min-h-[500px] flex flex-col relative overflow-hidden">
          ...
          <div className="flex gap-6 mb-8 max-w-2xl">
            ...
            <div className="flex-1">
              <div className="font-inter text-xs uppercase tracking-widest text-[var(--text-muted)] mb-2 font-medium">Cuvée Intelligence</div>
          ...
          <div className="mt-auto pt-8 border-t border-[var(--border-color)]">
            <div className="relative">
              <textarea
                className="w-full bg-[#F9F8F6] rounded-xl p-4 pr-12 outline-none resize-none font-inter text-sm leading-relaxed text-[var(--foreground)] placeholder:text-[var(--text-muted)] placeholder:font-light border-subtle focus:ring-1 focus:ring-[#D4AF37]/30 transition-shadow h-24"
